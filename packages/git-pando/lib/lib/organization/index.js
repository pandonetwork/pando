...
var factory_1 = __importDefault(require("./repository/factory"));
// const APP_IDS = {
...
var Organization = /** @class */ (function () {
    function Organization(pando, address, kernel, acl, colony) {
        this.pando = pando;
        this.address = address;
        this.kernel = kernel;
        this.acl = acl;
        this.colony = colony;
        this.repositories = new factory_1.default(this.pando, this);
    }
    return Organization;
}());
