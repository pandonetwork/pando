...
var handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                pando = _a.sent();
                spinner = ora_1.default(chalk_1.default.dim("Deploying organization")).start();
                _a.label = 2;
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, pando.organizations.deploy()];
            case 3:
                address = _a.sent();
                spinner.succeed(chalk_1.default.dim("Organization deployed at address " + address));
                return [3 /*break*/, 5];
            case 4:
                err_1 = _a.sent();
