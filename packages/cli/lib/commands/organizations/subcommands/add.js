...
var handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                spinner = ora_1.default(chalk_1.default.dim("Adding organization '" + argv.name + "'")).start();
            ...
            case 2:
                plant = _a.sent();
                return [4 /*yield*/, plant.organizations.add(argv.name, argv.address)];
            case 3:
                _a.sent();
                spinner.succeed(chalk_1.default.dim("Organization '" + argv.name + "' added"));
                return [3 /*break*/, 5];
            case 4:
                err_1 = _a.sent();
