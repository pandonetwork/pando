...
var handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var pando, plant, fiber, logs, _i, logs_1, log_, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                fiber = _a.sent();
                return [4 /*yield*/, fiber.log()];
            case 5:
                logs = _a.sent();
                for (_i = 0, logs_1 = logs; _i < logs_1.length; _i++) {
                    log_ = logs_1[_i];
                    console.log(chalk_1.default.cyan.bold.underline('SNAPSHOT #' + log_.id) + ' ' + chalk_1.default.magenta.bold(log_.message));
                    console.log(chalk_1.default.white(new Date(log_.timestamp).toString()));
                    console.log(chalk_1.default.dim(log_.tree));
                    console.log('');
                }
                return [3 /*break*/, 7];
            case 6:
