...
if [ "$SOLIDITY_COVERAGE" = true ]; then
  ...
  # npx /Users/osarrouy/Documents/dapp/truffle/packages/truffle/build/cli.bundled.js test ./test/index.js --network rpc "$@"
  npx ./node_modules/@ryhope/truffle/build/cli.bundled.js test ./test/index.js --network rpc "$@"
fi
kill -9 $testrpc_pid
