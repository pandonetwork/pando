    ...
    Index.prototype.cid = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = [{ path: path, content: fs_extra_1.default.readFileSync(path_1.default.join(this.plant.paths.root, path)) }];
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        for (_i = 0, modified_1 = modified; _i < modified_1.length; _i++) {
                            ...
                            updates.push({ type: 'put', key: path, value: index[path] });
                            promises.push(this.node.files.write('/' + path, fs_extra_1.default.readFileSync(path_1.default.join(this.plant.paths.root, path)), { create: true, parents: true }));
                        }
