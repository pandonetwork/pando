            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        ;
                        return [4 /*yield*/, Promise.all([index_1.default.for(this), db(this.paths.snapshots, { valueEncoding: 'json' })])];
                    case 1:
                                ...
                                if (file.type === 'file') {
                                    files.push({
                                        ...
                                        destination: path.length > 0
                                            ? path_1.default.join(path_1.default.dirname(path), file.path)
                                            : file.path
                    ...
                    case 9:
                        ...
                        _loop_1 = function (file) {
                            promises.push(fs_extra_1.default
                                .ensureFile(path_1.default.join(this_1.plant.paths.root, file.destination))
                                .then(function () { return fs_extra_1.default.writeFile(path_1.default.join(_this.plant.paths.root, file.destination), file.content); }));
                        };
                        this_1 = this;
