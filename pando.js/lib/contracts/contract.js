...
var Contract = /** @class */ (function () {
    ...
    Contract.deploy = function (signer) {
        var args = [];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        transaction = ethers_1.default.Contract.getDeployTransaction(this.artifact.bytecode, this.artifact.abi, args);
                        _a = transaction;
...
var Kernel = /** @class */ (function (_super) {
    ...
    Kernel.artifact = require('@aragon/os/build/contracts/DAOFactory.json');
    Kernel.interface = new ethers_1.default.Interface(Kernel.artifact.abi);
    return Kernel;
}(Contract));
